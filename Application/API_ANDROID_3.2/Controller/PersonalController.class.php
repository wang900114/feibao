...
//        SendMail('2426678072@qq.com', '测试', '测试正文');
        
        
        exit;
        header("Content-Type: text/html; charset=UTF-8");
        $str = '14106';
        $en_str = encodePass($str);
        echo "原字串：" . $str . "<br>";
        echo "加密后字串：" . $en_str . "<br>";
        echo "解密后字串：" .decodePass($en_str) . "<br>";
        echo "<hr>";
//        $uid=mt_rand(999, 9999);
        $str1 = (string) mt_rand(999, 9999);
        $en_str1 = encodePass($str1);
        echo "原字串：" . $str1 . "<br>";
        echo "加密后字串：" . $en_str1 . "<br>";
        echo "解密后字串：" .decodePass($en_str1) . "<br>";
        //短信测试
        $phone = '13261375433';
        //发送短信验证码
//        $code = mt_rand(99999, 999999);
//        $codeStatus = sendCode($phone, $code);
//        $code = 'Dear，您的广告“嘉泰国际大厦3”剩余飞币2000，不足6份代金券转发，请及时充值(mp.feibaokeji.com)';
//        $codeStatus = sendCode($phone, $code,2);
        //短信测试结束
    }
                        ...
                        if ($flag) {//判断密码是否正确
                            ...
                            if ($type == 1) {//验证修改登录密码
                                ...
                                if ($resError >= 5) {
                                    ...
                                    $ret['status'] = 23;
                                    //$ret['message'] = '密码输入错误!'.(3 - $resError);
                                    $ret['message'] = '操作码错误，请重新输入(' . (5 - $resError) . ')';
                                    $ret['getTimes'] = 5 - $resError;
                                }
                            }
                        }
