...
//        phone：会员注册手机号【必填项】
        header("Content-type:text/html;charset=utf-8");
        $html = '<form action="http://api.dev.feibaokeji.com/index.php/API_ANDROID_3.3/Friends/userMessageList" method="post">
                    <p>版本号: <input type="text" name="version" value="3.3" /></p>
                    <p>唯一码: <input type="text" name="userId" value="uhp43lEuxf70AEi3YcfJ9wIXXFxmc2UR02QxCC9u/NkRTnmxcM7M0BFbAFin2UYewfYDjXuf6PgtWKadPW9jL/3R3wq4" /></p>
                    <p>phone: <input type="text" name="phone" value="13681260087" /></p>
                    <p>agreement: <input type="text" name="agreement" value="3.2" /></p>
                    <p>mobile_platform: <input type="text" name="mobile_platform1" value="ios" /></p>
                    <p>mobile_platform: <input type="text" name="mobile_platform" value="android" /></p>
                    <p>friendId: <input type="text" name="friendId" value="3f874a54ye130ICQZeBgE" /></p>
...
//        var_dump($redis->set(42900, 12341234));
        echo $flow_time = $redis->get(42900);
        exit;
        $time = 1435052537;
