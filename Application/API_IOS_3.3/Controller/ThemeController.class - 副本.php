...
//            var_dump(M()->query($sql));exit;
            //数据查询
            $field = " a.id, a.big_image as bImage, a.list_image as listImage, a.title, a.content, b.id as userId, b.nickname as userName, a.add_time as addTime, a.period_number as periodNumber ";
