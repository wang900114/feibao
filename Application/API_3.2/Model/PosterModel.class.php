...
//        }
    ...
    public function getPosterAdvert($dataId, $field = 'id,title,lngMin,lngMax,latMax,pushCityId,latMin,address,type,status,pushType,warnPhone,shareUrl,collectTotal,weburl,addTime,startTime,endTime,integral,exposeTotalIntegral,extendTotalIntegral') {
